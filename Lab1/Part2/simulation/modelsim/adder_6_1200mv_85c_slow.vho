...
SIGNAL \U_FA0|sum~0_combout\ : std_logic;
SIGNAL \input1[1]~input_o\ : std_logic;
SIGNAL \input2[1]~input_o\ : std_logic;
SIGNAL \U_FA0|carry_out~0_combout\ : std_logic;
SIGNAL \U_FA1|sum~combout\ : std_logic;
...
\U_FA0|sum~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \U_FA0|sum~0_combout\ = \carry_in~input_o\ $ (\input2[0]~input_o\ $ (\input1[0]~input_o\))
...
\U_FA0|carry_out~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \U_FA0|carry_out~0_combout\ = (\carry_in~input_o\ & ((\input2[0]~input_o\) # (\input1[0]~input_o\))) # (!\carry_in~input_o\ & (\input2[0]~input_o\ & \input1[0]~input_o\))
...
PORT MAP (
	...
	datac => \input2[0]~input_o\,
	datad => \input1[0]~input_o\,
	combout => \U_FA0|carry_out~0_combout\);

-- Location: LCCOMB_X1_Y13_N20
\U_FA1|sum\ : cycloneiii_lcell_comb
-- Equation(s):
-- \U_FA1|sum~combout\ = \input1[1]~input_o\ $ (\input2[1]~input_o\ $ (\U_FA0|carry_out~0_combout\))
...
PORT MAP (
	...
	datad => \U_FA0|carry_out~0_combout\,
	combout => \U_FA1|sum~combout\);
...
-- Equation(s):
-- \U_FA1|carry_out~0_combout\ = (\input1[1]~input_o\ & ((\input2[1]~input_o\) # (\U_FA0|carry_out~0_combout\))) # (!\input1[1]~input_o\ & (\input2[1]~input_o\ & \U_FA0|carry_out~0_combout\))
...
-- Equation(s):
-- \U_FA2|sum~combout\ = \input1[2]~input_o\ $ (\input2[2]~input_o\ $ (\U_FA1|carry_out~0_combout\))
...
-- Equation(s):
-- \U_FA2|carry_out~0_combout\ = (\input1[2]~input_o\ & ((\input2[2]~input_o\) # (\U_FA1|carry_out~0_combout\))) # (!\input1[2]~input_o\ & (\input2[2]~input_o\ & \U_FA1|carry_out~0_combout\))
...
-- Equation(s):
-- \U_FA3|sum~combout\ = \input2[3]~input_o\ $ (\input1[3]~input_o\ $ (\U_FA2|carry_out~0_combout\))
...
-- Equation(s):
-- \U_FA3|carry_out~0_combout\ = (\input2[3]~input_o\ & ((\input1[3]~input_o\) # (\U_FA2|carry_out~0_combout\))) # (!\input2[3]~input_o\ & (\input1[3]~input_o\ & \U_FA2|carry_out~0_combout\))
